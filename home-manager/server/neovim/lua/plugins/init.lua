...
-- Load helper functions for orgmode exports
...
require('lazy').setup({
    ...
    config = function()
      ...
      require('orgmode').setup({
        ...
        mappings = {
          ...
          global = {
            org_agenda = '<prefix>a',
            org_capture = false,  -- Disabled to use custom citation picker at <leader>ac
          },
          org = {
            -- org_export = '<prefix>e',
            org_insert_link = false,  -- Disabled to use custom link creator at <leader>al
        ...
        org_custom_exports = {
          ...
          e = {
            ...
            action = function(exporter)
              ...
              local on_success = function(output)
                ...
                helpers.copy_to_clipboard(target)
              end
          ...
          H = {
            ...
            action = function(exporter)
              ...
              local on_success = function(output)
                helpers.update_hrefs_from_org_to_html(target)
                vim.api.nvim_echo({{ table.concat(output, '\n') }}, true, {})
                helpers.copy_to_clipboard(target)
              end
              local on_error = function(err)
  ...
  { -- Fuzzy Finder (files, etc)
    ...
    config = function()
      ...
      -- <leader>st is now used for TodoTelescope (see keymaps.lua)
